...
<html lang="en">
    ...
    <body>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                            <ul class="nav navbar-nav mu-menu navbar-right">
                              ...
                              <!--  <li><a href="athome.jsp">
                                        <select style="background-color: #ff871c; border-color: #ff871c;" Name="Home" Size="">  
                                            <option>At Home</option>  
                                            <option>At Library </option>  
                                        </select>  
                                    </a></li> -->
        ...
        <main role="main">
            ...
            <div class="container" style="margin-top: 50%; margin-bottom: 10%;">
            <table class="table">
