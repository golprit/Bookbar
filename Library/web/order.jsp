<%@page import="bookbar.com.entity.Category"%>
<%@page import="java.util.ArrayList"%>
<%@page import="bookbar.com.dao.BookOp"%>
<%@page import="bookbar.com.helper.DbConnection"%>
<%
                ...
                <nav class="navbar navbar-default mu-navbar">
                    <div class="container-fluid">
                        ...
                        <div class="navbar-header">
                            ...
                            <!-- Text Logo -->
                            <a class="navbar-brand" href="index.html"><img src="image/logo.png" alt="" style="height: 65px;"/>
